...
#include "helpers/ContextHelpers.h"
...
void VulkanContext::createInstance() {
    if (enableValidationLayers && !ContextUtil::checkValidationLayerSupport()) {
...
bool VulkanContext::isDeviceSuitable(VkPhysicalDevice device) {
    ...
    QueueFamilyIndices indices = ContextUtil::findQueueFamilies(device, surface);
    bool extensionSupported = ContextUtil::checkDeviceExtensionSupport(device);
    bool swapChainAdequate = false;
    if (extensionSupported) {
        SwapChainSupportDetails swapChainSupport = ContextUtil::querySwapChainSupport(device, surface);
...
void VulkanContext::createLogicalDevice() {
    QueueFamilyIndices indices = ContextUtil::findQueueFamilies(physicalDevice, surface);
...
void VulkanContext::createCommandPool() {
    QueueFamilyIndices queueFamilyIndices = ContextUtil::findQueueFamilies(physicalDevice, surface);
