...
void VulkanUtils::copyBuffer(VkCommandPool commandPool, VkDevice device, VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size, VkQueue queue) {
    VkCommandBuffer transferCommandBuffer = VulkanUtils::beginSingleTimeCommands(commandPool, device);
    VkBufferCopy copyRegion{};
    copyRegion.srcOffset = 0;
    copyRegion.dstOffset = 0;
    copyRegion.size = size;
    vkCmdCopyBuffer(transferCommandBuffer, srcBuffer, dstBuffer, 1, &copyRegion);
    VulkanUtils::endSingleTimeCommands(transferCommandBuffer, queue, device, commandPool);
}
...
void VulkanUtils::endSingleTimeCommands(VkCommandBuffer commandBuffer, VkQueue queue, VkDevice device, VkCommandPool commandPool) {
...
void VulkanUtils::transitionImageLayout(VkCommandPool commandPool, VkDevice device, VkQueue queue, VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
    ...
    VulkanUtils::endSingleTimeCommands(CommandBuffer, queue, device, commandPool);
}

void VulkanUtils::copyBufferToImage(VkDevice device, VkQueue queue, VkCommandPool commandPool, VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands(commandPool, device);
...
void VulkanUtils::createTextureImageView(VkDevice device, VkImage textureImage, VkImageView& textureImageView) {
