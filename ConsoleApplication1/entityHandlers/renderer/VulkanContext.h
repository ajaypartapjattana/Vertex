...
private:
    ...
    void createDescriptorSetLayout() {
        ...
        VkDescriptorSetLayoutBinding ColorSampler;
        ColorSampler.binding = 1;
        ColorSampler.descriptorCount = 1;
        ColorSampler.descriptorType = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
        ColorSampler.stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT;
        ColorSampler.pImmutableSamplers = nullptr;
        ...
        std::array<VkDescriptorSetLayoutBinding, 3> bindings = { uboLayoutBinding, ColorSampler, NormalSampler };
